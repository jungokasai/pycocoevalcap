...
class ClipScore:
    ...
    def compute_score(self, gts, res):
        ...
        scores = [{'CLIPScore': clipscore, 'RefCLIPScore': refclipscore, 'RefOnlyCLIPScore': refonlyclipscore}
                  for clipscore, refclipscore, refonlyclipscore in zip(per_instance_image_text, refclipscores, per_instance_text_text)]
        idx2score = {}
